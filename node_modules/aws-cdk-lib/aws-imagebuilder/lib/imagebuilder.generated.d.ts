...
export declare namespace CfnDistributionConfiguration {
    ...
    interface DistributionProperty {
         ...
         */
        readonly ssmParameterConfigurations?: Array<any | cdk.IResolvable> | cdk.IResolvable;
    }
    /**
 ...
 */
export declare class CfnLifecyclePolicy extends cdk.CfnResource implements cdk.IInspectable, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
 ...
 */
export declare class CfnWorkflow extends cdk.CfnResource implements cdk.IInspectable, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
